...
[![x-cmd/install — eget Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/eget.svg?lang=zh)](https://x-cmd.com/install/eget)
...
合计: **2,040** 行代码（覆盖前 5 种语言、共 **19** 个文件）。
...
- **Star**: 2,076 · **Fork**: 73 · **开放 issue**: 114 · **贡献者**: 9
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/eget.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:24:31Z._
